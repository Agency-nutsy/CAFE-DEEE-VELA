...
function MenuPage() {
  const [active, setActive] = reactExports.useState(menu[0].id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "paper-texture", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pt-36 pb-16 px-6 md:px-10 text-center border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.4em] text-gold mb-5", children: "The Menu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-5xl md:text-7xl text-cream text-balance", children: [
        "Our ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "Menu" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-serif italic text-lg md:text-xl text-foreground/80", children: "Handcrafted with care. Savored with love." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-20 z-30 bg-background/85 backdrop-blur-md border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto overflow-x-auto no-scrollbar", style: {
      scrollbarWidth: "none"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 md:justify-center px-6 md:px-10 min-w-max", children: menu.map((c) => {
      const isActive = c.id === active;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { id: `tab-${c.id}`, onClick: () => scrollToSection(c.id), className: `relative py-5 px-4 text-[11px] md:text-xs uppercase tracking-[0.22em] transition-colors whitespace-nowrap ${isActive ? "text-gold" : "text-muted-foreground hover:text-cream"}`, children: [
        c.name,
        isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { layoutId: "menu-underline", className: "absolute left-3 right-3 bottom-0 h-px bg-gold" })
      ] }, c.id);
    }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24 px-6 md:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-24", children: [
      menu.map((c, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: c.id, ref: (el) => sectionRefs.current[idx] = el, className: "scroll-mt-40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-4xl text-cream mb-12 text-center", children: c.name }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-x-12 gap-y-2", children: c.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group flex items-start gap-4 py-5 border-b border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, className: `mt-2.5 w-2.5 h-2.5 border shrink-0 ${item.veg ? "border-green-500" : "border-red-500"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block w-full h-full ${item.veg ? "bg-green-500" : "bg-red-500"} scale-50` }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-xl text-cream flex-1", children: item.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 border-b border-dotted border-border/50 translate-y-[-4px] hidden sm:block" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold tracking-wider font-medium", children: item.price })
            ] }),
            item.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground italic", children: item.description })
          ] })
        ] }) }, item.name)) })
      ] }, c.id)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-20 text-center text-xs text-muted-foreground italic max-w-md mx-auto", children: "Menu items and prices are subject to change. Please ask our staff for the latest menu." })
    ] }) })
  ] });
}
export {
